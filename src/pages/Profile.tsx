                ...
                <div className="space-y-4">
                  <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="text-base md:text-lg font-semibold text-[#111418]">Alex Barber</h3>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <p className="text-[#111418] text-sm md:text-base">alex@barberia.com</p>
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-[#60758a] mb-1">Teléfono</label>
                      <p className="text-[#111418] text-sm md:text-base">+1 234 567 890</p>
                    </div>
                    <div>
